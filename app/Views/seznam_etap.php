...
<div class="table-responsive card shadow-sm p-3 border-0 mt-4">
    ...
    foreach ($vse as $row) {
        $table->addRow(
            ...
            '<a href="' . base_url('dva/' . $row->id) . '" class="btn btn-outline-primary btn-sm px-3 shadow-sm fw-semibold">Proklik ;D</a>',
            '<a href="' . base_url('edit/' . $row->id) . '" class="btn btn-warning btn-sm px-3 shadow-sm fw-semibold">Upravit</a>'
        );
    }
